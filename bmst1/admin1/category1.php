...
$result = $conn->query("select * from category1");
if($result->num_rows > 0){
    ...
    while($row = $result->fetch_assoc()){
        ...
        <td><a href="category_manage1.php?id='.$id.'"> Edit</a>/<button>Delete</button></td>
       </tr>' ;
    }
...
?>
<h2>Category</h2>
<a href="category_manage1.php">Add New Category</a>
<table border="1">
    <thead>
        <tr>   
        <th>S.no</th>
